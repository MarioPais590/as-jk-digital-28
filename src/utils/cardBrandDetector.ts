...
const cardIcons = {
  ...
  mastercard: {
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      { tag: 'rect', props: { key: 'bg', width: "24", height: "16", rx: "3", fill: "#EB001B" } },
      { tag: 'circle', props: { key: 'c1', cx: "9", cy: "8", r: "5", fill: "#FF5F00" } },
      { tag: 'circle', props: { key: 'c2', cx: "15", cy: "8", r: "5", fill: "#F79E1B" } },
      { tag: 'path', props: { key: 'overlap', d: "M12 4.5a4.99 4.99 0 000 7 4.99 4.99 0 000-7z", fill: "#FF5F00" } }
    ]
  },
  elo: {
    width: "32",
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      { tag: 'rect', props: { key: 'bg', width: "24", height: "16", rx: "3", fill: "#FFD700" } },
      { tag: 'path', props: { key: 'box', d: "M6 5h12v6H6z", fill: "#000" } },
      { tag: 'text', props: { key: 'text', x: "12", y: "10", textAnchor: "middle", fontSize: "6", fill: "#FFD700", fontWeight: "bold" }, children: "ELO" }
    ]
  },
  amex: {
    width: "32",
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      { tag: 'rect', props: { key: 'bg', width: "24", height: "16", rx: "3", fill: "#006FCF" } },
      { tag: 'path', props: { key: 'box', d: "M4 5h16v6H4z", fill: "#fff" } },
      { tag: 'text', props: { key: 'text', x: "12", y: "9.5", textAnchor: "middle", fontSize: "5", fill: "#006FCF", fontWeight: "bold" }, children: "AMEX" }
    ]
  },
  generico: {
    width: "32",
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      { tag: 'rect', props: { key: 'bg', width: "24", height: "16", rx: "3", fill: "#6B7280", stroke: "#D1D5DB" } },
      { tag: 'rect', props: { key: 'stripe', x: "4", y: "6", width: "16", height: "2", fill: "#D1D5DB" } },
      { tag: 'rect', props: { key: 'chip', x: "4", y: "10", width: "8", height: "1", fill: "#D1D5DB" } }
    ]
  }
};

export const getCardBrandIcon = (cardNumber: string) => {
