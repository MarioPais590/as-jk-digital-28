...
export const SecureCreditCardVisual: React.FC<SecureCreditCardVisualProps> = ({
  usage,
  onEdit,
  onDelete,
  onEditColor,
  ...
  // Always mask the card number for security
  const maskedNumber = card.numero_cartao ? maskCardNumber(card.numero_cartao) : '';
  ...
  return (
    <div className="relative group">
      ...
      <div className={`w-[340px] h-[200px] ${bgColor} ${textColor} rounded-xl shadow-md p-6 relative overflow-hidden transition-transform hover:scale-105`}>
        ...
        {/* Número mascarado - SEMPRE mascarado por segurança */}
        {maskedNumber && (
          <div className="mb-4">
